...
<xsl:stylesheet 
    ...
    <xsl:template match="/">
        <xsl:variable name="doc_title" select="'Autographen Leo Thun/Briefe aus anderen Archiven'"/>
                    ...
                    <div class="container-fluid">
                        <div class="card">
                            <div class="card-header" style="text-align:center;">
                                ...
                                <small><xsl:value-of select="count(collection('../data/editions')//tei:TEI[not(contains(.//tei:repository, 'Linie Tetschen, Nachlass Leo'))])"/><xsl:text> </xsl:text>Dokumente</small>
                            </div>
                            <div class="card-body">
                                <table class="table table-striped display" id="tocTable" style="width:100%">
                                    ...
                                    <tbody>
                                        <xsl:for-each select="collection('../data/editions')//tei:TEI[not(contains(.//tei:repository, 'Linie Tetschen, Nachlass Leo'))]">
